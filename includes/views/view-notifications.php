    ...
    <div class="mkv-grid-2">
        ...
        <div class="mkv-card" style="border-left:3px solid var(--mkv-yellow);">
            ...
            <div class="mkv-card-body" style="padding:0;">
                <?php if (empty($low_stock)): ?>
                    <p style="color:var(--mkv-text-muted); text-align:center; padding:30px;">
                        <i class="hgi-stroke hgi-checkmark-circle-02" style="font-size:32px; color:var(--mkv-green); display:block; margin-bottom:12px;"></i>
        ...
        <div class="mkv-card" style="grid-column: span 2;">
            ...
            <div class="mkv-card-body" style="padding:0;">
                ...
                <?php else: ?>
                    <div class="mkv-card-scroll mkv-alerts-scroll">
                        <ul class="mkv-widget-list">
                            ...
                            <li style="align-items:flex-start;">
                                ...
                                <span style="font-size:12px; color:var(--mkv-text-muted); margin-left:16px; white-space:nowrap; font-variant-numeric:tabular-nums;">
